...
<body>
    ...
    <div class="mx-auto" style="width: 800px">
        <div class="card" style="margin top: 10px">
            ...
            <div class="card-body">
                <form action="/komoditas/store" method="post">
                    {{ csrf_field() }}
                    ...
                    <table class="table table-bordered data-table">
                        ...
                        @foreach ($komoditas as $k)
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="{{ route('komoditas.destroy', $k->id_komoditas) }}">
                                        <a class="btn btn-primary"
                                            href="/komoditas/edit/{{ $k->id_komoditas }}">Edit</a>
                                        {{ csrf_field() }}
...
<section>
    ...
    <script type="text/javascript">
        $('.show_Confirm').click(function(event) {
            ...
            var name = $(this).data("id_komoditas");
            event.preventDefault();
            swal({
                    title: `Apakah anda ingin menghapus nama komoditas?`,
                    text: "Jika menghapus nama komoditas akan hilang data.",
                    icon: "warning",
                    buttons: true,
                    dangerMode: true,
                })
