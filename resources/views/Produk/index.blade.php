            ...
            <div class="card-body">
                <form action="/produk/store" method="post">
                    ...
                    <div class="form-group container">
                        ...
                        <select class="form-control" name="id_komoditas">
                    ...
                    <table class="table table-bordered data-table">
                        ...
                        @foreach ($produk as $p)
                            <tr>
                                ...
                                <td>{{ $p->nama_produk }}</td>
                                <td>
                                    <form method="POST" action="{{ route('produk.destroy', $p->id_produk) }}">
                                        <a class="btn btn-primary" href="/produk/edit/{{ $p->id_produk }}">Edit</a>
                                        {{ csrf_field() }}
...
<section>
    ...
    <script type="text/javascript">
        $('.show_Confirm').click(function(event) {
            ...
            var name = $(this).data("id_produk");
            event.preventDefault();
            swal({
                    title: `Apakah anda ingin menghapus nama produk?`,
                    text: "Jika menghapus nama produk akan hilang data.",
                    icon: "warning",
                    buttons: true,
                    dangerMode: true,
                })
